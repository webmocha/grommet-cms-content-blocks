...
import { BlockVideoButtonForm } from '../BlockVideoButton';
...
class BlockParagraphVideoCTAsForm extends Component {
  ...
  render() {
    ...
    const confirmLayer = (this.state.confirmLayer)
      ? (
        <ConfirmLayer
          name={`Video CTA ${activeSlideIndex + 1}`}
...
export default BlockParagraphVideoCTAsForm;